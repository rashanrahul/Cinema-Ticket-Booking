...
if($conn){
    ...
    $sql="insert into application (firstname,email,mobile,id_no,date,movie,time,number,districts)values('$firstname','$email','$mobile','$id_no','$date','$movie','$time','$number','$districts')";
    $result=mysqli_query($conn,$sql);
    if($result){
        
        echo "<script type='text/javascript'>alert ('successfully Your Information') </script>";
...
<body>
    ...
    <form action="cinema booking form.php" method="POST"><br> 
        <fieldset>
            <div class="video">
